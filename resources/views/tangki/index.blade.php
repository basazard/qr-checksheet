<x-app-layout>
    ...
    <div class="py-2 flex justify-center gap-x-10">
        ...
        <a href="{{ route('tangki.show', $authorization->slug) }}" class="w-40 block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
